...
class MainActivity : AppCompatActivity() {
    ...
    private val challengSevenButton: Button get() = findViewById(R.id.challenge_seven)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        challengSevenButton.setOnClickListener { launchPlaySoundActivity() }
    ...
    private fun launchPlaySoundActivity() {
        val i = Intent(this, PlaySoundActivity::class.java)
        startActivity(i)
    }
}